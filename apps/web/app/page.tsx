    ...
    <section className="mx-auto grid min-h-[calc(100vh-80px)] max-w-7xl items-center gap-10 px-6 py-16 lg:grid-cols-[1.2fr_0.8fr]">
      <div className="space-y-6">
        ...
        <p className="max-w-2xl text-lg text-slate-300">
          Mood-aware itineraries, predictive disruption shielding, local pulse heatmaps,
          collaborative conflict resolution, and Travel DNA insights in one adaptive trip brain.
        </p>
