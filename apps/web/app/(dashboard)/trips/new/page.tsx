  ...
  return (
    <section className="space-y-8">
      <div className="max-w-3xl">
        <p className="text-sm uppercase tracking-[0.3em] text-sky-300">Trip creation wizard</p>
        ...
        >
          {step === 0 && (
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-300">
                Price forecast overlay: Prices are 12% below typical peak-week patterns for this
                window.
              </p>
            </div>
          )}
          {step === 1 && (
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-300">
                Based on your mood, we&apos;ll prioritize quieter experiences this morning.
              </p>
            </div>
          )}
          {step === 2 && (
            ...
            <div className="space-y-4">
              ...
              <div className="block">
                ...
                <input
                  ...
                  className="w-full"
                  aria-label="Budget estimate slider"
                />
              </div>
              <p className="text-sm text-slate-300">
          ...
          {step === 4 && (
            <div className="space-y-4">
              ...
              <div className="rounded-3xl border border-dashed border-white/20 p-6 text-sm text-slate-300">
                Share link, QR code, and invite-email surface will plug into Firebase notifications
                and presence.
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-3xl border border-sky-300/30 bg-sky-400/10 p-6">
                <p className="text-sm text-sky-100">
                  ODYSSEY AI is analyzing activities, optimizing routes, checking disruptions, and
